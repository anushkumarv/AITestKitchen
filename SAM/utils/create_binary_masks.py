# This is adapted from https://vizwiz.cs.colorado.edu/VizWiz_final/VizWiz_grounding/create_binary_masks.py
...
def Toarray(xycoo):
    ...
    return xycooArray
def StoreMasks(XY,width,height,writepath,SaveFormat): 
    """
...
def main(task,SaveFormat):
    ...
    with open(path,'r',encoding="utf-8") as grounding_file:
        ...
        for data in datas:
            ...
            StoreMasks(XY,width,height,writepath,SaveFormat)
